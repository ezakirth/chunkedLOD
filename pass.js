export default class Pass {
  ...
  render() {
    ...
    if (this.pass == 1) gl.uniform2f(this.uPixel, 6 / width, 0);
    else gl.uniform2f(this.uPixel, 0, 6 / height);
  ...
  init() {
    ...
    this.indices = new Uint16Array([2, 1, 0, 3, 2, 0]);
