...
export function initWorkers() {
  workerGenerateTerrain = new Worker("./workers/workerGenerateTerrain.js", {
    type: "module",
  });
  ...
  workerUpdateShadows = new Worker("./workers/workerUpdateShadows.js", {
    type: "module",
  });
  ...
  workerUpdateShadows.onerror = function (e) {
    console.log("error");
  };

  workerGenerateChunk = new Worker("./workers/workerGenerateChunk.js", {
    type: "module",
  });
...
export function generateTerrain(id) {
  var worker = workerGenerateTerrain;
  if (
    worker.getStatus(0) == "ready" &&
    workerUpdateShadows.getStatus(0) == "ready"
  ) {
    worker.setStatus(0, "busy");
...
export function updateShadows(id) {
